    ...
    public partial class Gridview_template_item_view1 : System.Web.UI.Page
    {
        ...
        protected void GetStudents()
        {
            ...
            using (DefaultConnection db = new DefaultConnection())
            {
                ...
                var Gridview_template_item_view1 = (from allStudents in db.Students
                                                    select allStudents);

                // bind the result to the GridView
                DefaultGridView.DataSource = Gridview_template_item_view1.AsQueryable().OrderBy(SortString).ToList();
        ...
        protected void StudentsGridView_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            int StudentID = Convert.ToInt32(DefaultGridView.DataKeys[selectedRow].Values["StudentID"]);
        ...
        protected void StudentsGridView_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            DefaultGridView.PageIndex = e.NewPageIndex;
        ...
        protected void PageSizeDropDownList_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            DefaultGridView.PageSize = Convert.ToInt32(PageSizeDropDownList.SelectedValue);
        ...
        protected void StudentsGridView_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (IsPostBack)
            {
                if (e.Row.RowType == DataControlRowType.Header) // if header row has been clicked
                {
                    ...
                    for (int index = 0; index < DefaultGridView.Columns.Count - 1; index++)
                    {
                        if (DefaultGridView.Columns[index].SortExpression == Session["SortColumn"].ToString())
                        {
